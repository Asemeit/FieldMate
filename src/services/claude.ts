...
// Multi-lingual high-fidelity database of crop diseases to power the Offline Mock advisory and fallback simulations
  ...
  private async buildDiagnosisFromML(
    ...
    if (mlResult.isHealthy) {
      ...
      recommendation = matched
        ...
        : {
            ...(DISEASE_DATABASE[cropType][0] || DISEASE_DATABASE.Maize[0]),
